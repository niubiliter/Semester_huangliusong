<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Down_sub3.aspx.cs" Inherits="Down_sub3" %>
                ...
                <div style="width: 140px; height: 85px;">
                    ...
                    <div style="width: 92px; height: 85px; float: left;">
                        ...
                        <div style="width: 54px; height: 25px; line-height: 25px; background-color: #EEEEEE;
                            ...
                            <a class="btn-dl" href="0" style="color: rgb(102, 102, 102); text-decoration: none;
