<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Down_sub11.aspx.cs" Inherits="Down_sub11" %>
    ...
    <div style="width: 100%; height: 100%;">
        <asp:DataList ID="DataList1" runat="server" RepeatColumns="8"  RepeatDirection="Horizontal">
            ...
            <div style="width: 80px; height: 55px; text-align: center;">
                <img style="width: 60px; height: 60px;" src="down_image/shou1.jpg" />
            </div>
            <div style="width: 80px; height: 35px;">
                <a href="http://a.xiazaiba.com/app/94.html" style="color: rgb(51, 51, 51); text-decoration: none;
